#!/bin/sh
### BEGIN INIT INFO
# Provides:          ss-local-auto-start
# Required-Start:    $network $local_fs $remote_fs
# Required-Stop:     $remote_fs
# Default-Start:     2 3 4 5
# Default-Stop:      0 1 6
# Short-Description: ss-local-auto-start
# Description:       ss-local auto start deamon.
### END INIT INFO

# Author: Bao Feng Yv <baofengyv@gmail.com>

# Configuration file
CONFFILE="/home/b/shadowsocks/config.json"

# PATH should only include /usr/ if it runs after the mountnfs.sh script
PATH=/sbin:/usr/sbin:/bin:/usr/bin
DESC=ss-local-auto-start       # Introduce a short description here
NAME=ss-local-auto-start       # Introduce the short server's name here
